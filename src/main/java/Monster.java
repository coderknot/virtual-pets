...
// Method to periodically check the status of our pet. If any of its levels reach zero, this method will alert us it has died, and our front end will break the news to our user.
