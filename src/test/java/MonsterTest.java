...
public class MonsterTest {
  ...
  public void timer_executesDepleteLevelsMethod() {
    ...
    try {
      Thread.sleep(6000); // not calling sleep method; this is a built-in static method in Java's Thread class that temporarily pauses a program for a specified number of milliseconds
